...
class TestPermissionRequestWorkflow(unittest.TestCase):
    ...
    def test_user_can_create_request(self):
        ...
        payload = SimpleNamespace(permission="document.update", document_id=None, reason="Besoin")
    ...
    def test_admin_can_read_all_requests(self):
        ...
        with patch(
            "app.services.permission_request_service.permission_request_repository.get_all",
            return_value=expected,
        ):
